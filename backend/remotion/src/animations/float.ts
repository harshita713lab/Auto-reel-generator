...
export const float = ({ progress, amplitude = 10, frequency = 1 }: FloatParams) => {
...
export const floatIn = ({ progress, amplitude = 20, frequency = 0.5 }: FloatParams) => {
...
export const floatOut = ({ progress, amplitude = 20, frequency = 0.5 }: FloatParams) => {
