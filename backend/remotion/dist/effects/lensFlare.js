...
export const LensFlare = ({ intensity = 0.4, position = 'topRight', color = '#FFA500', size = 50, animated = true, }) => {
    ...
    return (_jsxs("div", { style: {
            ...
            opacity: intensity * pulse,
                    ...
                    filter: 'blur(2px)',
                    opacity: 0.8,
                } }), [0, 45, 90, 135, 180, 225, 270, 315].map((angle, i) => (_jsx("div", { style: {
                    position: 'absolute',
                    top: '50%',
                    left: '50%',
