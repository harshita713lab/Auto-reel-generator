...
export const WhiteCardPolaroidStack = ({ images = [], backgroundColor = "linear-gradient(135deg, #111122, #1a1a3a)", cardColor = "#ffffff", showCounter = true, beatTimestamps = [], }) => {
    ...
    const lightLeakOpacity = interpolate(frame, [0, 50, 200, 350, 450], [0.2, 0.45, 0.25, 0.5, 0.2]);
    return (_jsxs(AbsoluteFill, { style: {
            ...
            overflow: "hidden",
                    ...
                    transform: `scale(${beatScale})`,
                    zIndex: 10,
                }, children: imageList.map((img, index) => {
                ...
                `,
                            ...
                            zIndex: index + 1,
                                    ...
                                    alignItems: "center",
                                    padding: "0 14px",
                                }, children: showCounter && (_jsxs("div", { style: {
                                        fontSize: 20,
                                        color: "#777",
                                        fontWeight: 700,
                                        letterSpacing: 1,
                                    }, children: [String(index + 1).padStart(2, "0"), " / ", String(imageList.length).padStart(2, "0")] })) }), _jsx("div", { style: {
                                    position: "absolute",
                                    inset: 0,
                                    borderRadius: 14,
