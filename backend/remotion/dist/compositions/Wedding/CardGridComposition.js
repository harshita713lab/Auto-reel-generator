...
export const WhiteCardGrid3x3 = ({ images = [], beatTimestamps = [], }) => {
    ...
    return (_jsxs(AbsoluteFill, { style: {
            background: "#000000",
            overflow: "hidden",
        }, children: [isGridPhase && (_jsx("div", { style: {
                    position: "relative",
                    width: "100%",
                    height: "100%",
                    overflow: "hidden",
                    ...
                    return (_jsx("div", { style: {
                        ...
                        }, children: _jsx(Img, { src: imageList[index]?.path, style: {
                                width: "100%",
                                height: "100%",
                                objectFit: "cover",
                ...
                }) })), !isGridPhase && imageList[currentSpotlightIndex] && (_jsx("div", { style: {
                    position: "absolute",
                    inset: 0,
                    width: "100%",
                    height: "100%",
