...
export const useTransition = (config) => {
    const frame = useCurrentFrame();
    const { durationInFrames, type = 'fade', direction = 'center', easing = Easing.inOut(Easing.ease), delay = 0, } = config;
...
export const useTransitionBetween = (config) => {
    const frame = useCurrentFrame();
    const { durationInFrames, type = 'fade', elementCount = 2, activeIndex = 0, easing = Easing.inOut(Easing.ease), } = config;
...
export const usePageTransition = (config) => {
