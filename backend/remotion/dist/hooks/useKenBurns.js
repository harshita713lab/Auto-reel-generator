...
export const useKenBurns = (config) => {
    const frame = useCurrentFrame();
    const { durationInFrames, scale = 1.3, startX = 0, startY = 0, endX = 10, endY = 10, zoomDirection = 'in', easing = (t) => t, } = config;
...
export const useKenBurnsImage = (config) => {
