...
export const WhipTransition = ({ children, durationInFrames = 20, direction = 'right', intensity = 1, delay = 0, }) => {
...
export const WhipStreakTransition = (props) => {
    const frame = useCurrentFrame();
    ...
    return (_jsxs("div", { style: {
            ...
            overflow: 'hidden',
                    ...
                    transition: 'all 0.02s ease-out',
                }, children: props.children }), _jsx("div", { style: {
                    position: 'absolute',
                    top: 0,
                    left: 0,
                    width: '100%',
